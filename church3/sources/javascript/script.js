...
for(var i=0; i<otherImages.length; i++){
	otherImages[i].style.background= "url(./sources/stylesheets/"+i+".jpg)no-repeat center center";
...
backImage.addEventListener("click", function(){
	...
	currentImage --;
	mainImage.style.background = 'url("./sources/stylesheets/'+currentImage+'.jpg")no-repeat center center';
	mainImage.style.backgroundSize = "cover";
	mainImage.style.backgroundPosition = "center";
});
